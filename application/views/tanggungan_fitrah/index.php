        ...
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Aktif Dihitung</div>
    ...
    <div class="col-md-6">
        <div class="card border-left-danger shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Tidak Dihitung</div>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title mb-0">
            <i class="fas fa-user-friends mr-2"></i>Tanggungan Zakat Fitrah
        </h3>
        <a href="<?php echo site_url('tanggungan_fitrah/create'); ?>" class="btn btn-primary btn-sm float-right">
            <i class="fas fa-plus"></i> Tambah Tanggungan
        </a>
    </div>
    <div class="card-body">
        <form method="get" action="<?php echo site_url('tanggungan_fitrah'); ?>" class="mb-3">
            <div class="row">
                <div class="col-md-8">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" name="q" class="form-control" placeholder="Cari muzakki, nama anggota, hubungan..."
                            value="<?php echo html_escape(isset($search) ? $search : ''); ?>">
                        <div class="input-group-append">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-search mr-1"></i>Cari
                            </button>
                            <a href="<?php echo site_url('tanggungan_fitrah'); ?>" class="btn btn-default">
        ...
        <table id="tanggungan-table" class="table table-sm table-bordered table-striped table-hover text-nowrap" style="width:100%">
            <thead>
                <tr>
                    <th width="50">No</th>
                    <th>Muzakki</th>
            ...
            <tbody>
                <?php if (!empty($rows)): ?>
                    ...
                    <?php foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td><?php echo html_escape($row->hubungan_keluarga ? $row->hubungan_keluarga : '-'); ?></td>
                            <td>
                                <?php if ((int) $row->aktif_dihitung === 1): ?>
                                    <span class="badge badge-success"><i class="fas fa-check mr-1"></i>Ya</span>
                                <?php else: ?>
                                    <span class="badge badge-danger"><i class="fas fa-times mr-1"></i>Tidak</span>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group" aria-label="Aksi">
                                    <a class="btn btn-warning" href="<?php echo site_url('tanggungan_fitrah/edit/' . $row->id); ?>" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger" href="<?php echo site_url('tanggungan_fitrah/delete/' . $row->id); ?>"
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6" class="text-center text-muted">Belum ada data tanggungan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
