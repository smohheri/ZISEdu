...
class Laporan_model extends CI_Model
{
    ...
    public function get_laporan_fitrah($startDate, $endDate)
    {
        return $this->db
    ...
    public function get_laporan_mal($startDate, $endDate)
    {
        return $this->db
    ...
    public function get_laporan_penyaluran($startDate, $endDate)
    {
        return $this->db
