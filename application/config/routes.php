...
$route['zakat_fitrah/export_pdf/(:num)'] = 'zakat_fitrah/export_pdf/$1';
...
$route['zakat_mal/export_pdf/(:num)'] = 'zakat_mal/export_pdf/$1';
...
$route['penyaluran/detail_json/(:num)'] = 'penyaluran/detail_json/$1';
...
$route['infaq_shodaqoh/kwitansi/(:num)'] = 'infaq_shodaqoh/kwitansi/$1';
$route['infaq_shodaqoh/export_pdf/(:num)'] = 'infaq_shodaqoh/export_pdf/$1';
...
$route['transaksi_unified'] = 'transaksi_unified';
$route['transaksi_unified/store'] = 'transaksi_unified/store';
$route['transaksi_unified/kwitansi/(:any)'] = 'transaksi_unified/kwitansi/$1';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
